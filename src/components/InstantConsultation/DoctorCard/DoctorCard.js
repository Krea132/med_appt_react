    ...
    <div className='col mb-4'>
      <div className="card">
        ...
        <Popup
            ...
            trigger={
              <button style={{ 'border-top-left-radius': '0', 'border-top-right-radius': '0'}} className={`btn btn-primary rounded-bottom mr-1 p-2 ${appointments.length > 0 ? 'cancel-appointment' : ''}`}>
